...
def run_and_test_code(file_name):
    try: 
        ...
        if(test_result.returncode == 1):
            ...
            print(color.Fore.RED + f"Error running generated code! Error:{test_result.stdout}")
            return False, {"role": "user",
        ...
        short_traceback = "line " + full_traceback.split("File")[-1].split("line")[-1]
        print(color.Fore.RED + f"excaption Error running generated code! Error:{short_traceback}")
